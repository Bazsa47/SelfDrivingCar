...
public class RedGeneticManager : MonoBehaviour
{
    [Header("References")]
    public RedCarController controller;
    ...
    {
        population = new RedNNet[initialPopulation];
    ...
    private void FillPopulationWithRandomValues(RedNNet[] newPopulation, int startingIndex)
    {
        while (startingIndex < initialPopulation)
        {
            newPopulation[startingIndex] = new RedNNet();
            newPopulation[startingIndex].Initialise(controller.LAYERS, controller.NEURONS);
            startingIndex++;
        }
    }

    public void Death(float fitness, RedNNet network)
    {
    ...
    private void RePopulate()
    {
        ...
        RedNNet[] newPopulation = PickBestPopulation();
    ...
    private void Mutate(RedNNet[] newPopulation)
    {
    ...
    private void Crossover(RedNNet[] newPopulation)
    {
        for (int i = 0; i < numberToCrossover; i += 2)
        {
            ...
            RedNNet Child1 = new RedNNet();
            RedNNet Child2 = new RedNNet();
    ...
    private RedNNet[] PickBestPopulation()
    {

        RedNNet[] newPopulation = new RedNNet[initialPopulation];
